            ...
            <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img src="C:\Users\PC1\Pictures\norway.png" class="d-block w-100 img-fluid" alt="Norway destination">
                    <div class="carousel-caption">
                        <h2 class="text-uppercase">Norway</h2>
                      </div>
                  </div>
                  <div class="carousel-item">
                    <img src="C:\Users\PC1\Pictures\sweden.png" class="d-block w-100 img-fluid" alt="Sweden destination">
                    <div class="carousel-caption">
                        <h2 class="text-uppercase">Sweden</h2>
                      </div>
                  </div>
                  <div class="carousel-item">
                    <img src="C:\Users\PC1\Pictures\iceland.png" class="d-block w-100 img-fluid" alt="Iceland destination">
                    <div class="carousel-caption">
                    ...
                    <div class="container position-relative px-5 py-5">
                      ...
                      <div class="row icon-boxes gx-4">
                        <div class="col-md-6 col-lg-4 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="zoom-in" data-aos-delay="200">
                          <div class="div-dest">
                            <div class="con-dark icon-box p-3">
                                <img src="C:\Users\PC1\Pictures\destination1-iceland.jpg" alt="Iceland destination" class="d-block w-100 img-fluid">
                        ...
                        <div class="col-md-6 col-lg-4 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="zoom-in" data-aos-delay="300">
                          <div class="dic-dest">
                            <div class="con-light icon-box p-3">
                                <img src="C:\Users\PC1\Pictures\destination2-sweden.jpg" alt="Sweden destination" class="d-block w-100 img-fluid">
                        ...
                        <div class="col-md-6 col-lg-4 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="zoom-in" data-aos-delay="400">
                          <div class="div-dest">
                            <div class="con-dark icon-box p-3">
                                <img src="C:\Users\PC1\Pictures\destination3-norway.jpg" alt="Norway destination" class="d-block w-100 img-fluid">
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-0 p-4">
                              <div class="row">
                                <div class="boxfield col-lg-6 col-md-6 col-sm-6 icon-boxes">
                                    ...
                                    <img src="C:\Users\PC1\Pictures\icon1.png" alt="icon about us customer service" class="icon mx-auto d-block">
                                </div>
                                <div class="boxfield icon-boxes col-lg-6 col-md-6 col-sm-6">
                                    ...
                                    <p class="text-center benefits">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse ut odio ligula. Nunc sed felis rhoncus, sagittis purus ut, feugiat felis. </p>
                                    <img src="C:\Users\PC1\Pictures\icon2.png" alt="icon about us security" class="icon mx-auto d-block">
                                </div>
                                <div class="boxfield icon-boxes col-lg-6 col-md-6 col-sm-6">
                                    ...
                                    <p class="text-center benefits">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse ut odio ligula. Nunc sed felis rhoncus, sagittis purus ut, feugiat felis. </p>
                                    <img src="C:\Users\PC1\Pictures\icon3.png" alt="icon about us reviews" class="icon mx-auto d-block">
                                </div>
                                <div class="boxfield icon-boxes col-lg-6 col-md-6 col-sm-6">
                                    <div class="feature bg-primary bg-gradient text-white rounded-3"><i class="bi bi-building"></i></div>
                                    <h4 class="fw-bolder text-center py-3">Affordability</h4>
                                    <p class="text-center benefits">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse ut odio ligula. Nunc sed felis rhoncus, sagittis purus ut, feugiat felis. </p>
                                    <img src="C:\Users\PC1\Pictures\icon4.png" alt="icon about us affordability" class="icon mx-auto d-block">
                                </div>
                    ...
                    <div class="container px-5 py-5">
                        <div class="row gx-5">
                            ...
                            <div class="rew2 col-lg-4 mb-5 mb-lg-0">
                                <img src="C:\Users\PC1\Pictures\customer3.jpg" alt="customer review photo" class="customerpic mx-auto d-block">
                            </div>
                            <div class="rew1 col-lg-4 mb-5 mb-lg-0">
                                <div class="feature bg-primary bg-gradient text-white rounded-3 mb-3"><i class="bi bi-toggles2"></i></div>
                                <h4 class="fw-bold text-center">★★★★★</h4>
                        ...
                        <div class="row gx-5">
                            <div class="rew2 col-lg-4 mb-5 mb-lg-0">
                                <img src="C:\Users\PC1\Pictures\customer1.jpg" alt="customer review photo" class="customerpic mx-auto d-block">
                            </div>
                            ...
                            <div class="rew2 col-lg-4 mb-5 mb-lg-0">
                                <img src="C:\Users\PC1\Pictures\customer2.jpg" alt="customer review photo" class="customerpic mx-auto d-block">
                            </div>
                        </div>
                    </div>
                </section>
