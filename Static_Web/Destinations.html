        ...
        <div class="container my-container">
            ...
            <div class="row justify-content-center my-row-1">
                ...
                <div class="col-md-7 my-col-2">
                    <div class="iceland-article">
                        ...
                        <br>
                        <a href="H:\ProgrammingVSCode\html\Projects\North Travel\icelandpage.html" class="link my-link">Learn more</a>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center my-row-2">
                <div class="col-md-7 my-col-3">
                    <div class="sweden-article">
                        ...
                        In hendrerit volutpat nisi eget luctus. Phasellus a pharetra dui.
                        <br>
                        <a href="H:\ProgrammingVSCode\html\Projects\North Travel\swedenpage.html" class="link my-link">Learn more</a>
                        </p>
                    </div>
                </div>
            ...
            <div class="row justify-content-center my-row-3">
                <div class="col-md-4 justify-content-center my-col-5">
                    <img src="images/destination3-norway.jpg" class="img-destinationsimg-fluid" alt="">
                </div>
                ...
                <div class="col-md-7 my-col-6">
                    <div class="norway-article">
                        ...
                        In hendrerit volutpat nisi eget luctus. Phasellus a pharetra dui.
                        <br>
                        <a href="H:\ProgrammingVSCode\html\Projects\North Travel\norwaypage.html" class="link my-link">Learn more</a>
                        </p>
                    </div>
                </div>
            </div>
